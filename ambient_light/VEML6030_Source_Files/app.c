 ...
 *****************************************************************************/
void ambient_LightPowerON(void)
{
  printf("ambient_LightPowerON()\r\n");
...
static void app_periodic_timer_cb(app_timer_t *timer, void *data)
{
  ...
  //start_VEML6030();
  int32_t integration_time = 0;
  uint32_t gain = 1;
  configure_VEML6030(integration_time, gain, true, true);
  get_VEML6030_Values(integration_time, gain);
